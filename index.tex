...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, rightrule=.15mm, left=2mm, arc=.35mm, opacityback=0, colback=white, coltitle=black, opacitybacktitle=0.6, titlerule=0mm, bottomrule=.15mm, toprule=.15mm, leftrule=.75mm, breakable, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Types of error bar}, colbacktitle=quarto-callout-note-color!10!white]
