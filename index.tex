...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Types of error bar}, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, toptitle=1mm, arc=.35mm, colback=white, opacityback=0, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, coltitle=black, bottomtitle=1mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, left=2mm]
