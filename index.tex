...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, rightrule=.15mm, colframe=quarto-callout-note-color-frame, breakable, toprule=.15mm, left=2mm, titlerule=0mm, arc=.35mm, opacitybacktitle=0.6, bottomtitle=1mm, opacityback=0, colback=white, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Types of error bar}, bottomrule=.15mm, leftrule=.75mm]
