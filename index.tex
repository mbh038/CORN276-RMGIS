...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colframe=quarto-callout-note-color-frame, titlerule=0mm, bottomrule=.15mm, arc=.35mm, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, breakable, bottomtitle=1mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Types of error bar}, coltitle=black, toprule=.15mm, leftrule=.75mm, left=2mm, colback=white, opacitybacktitle=0.6]
