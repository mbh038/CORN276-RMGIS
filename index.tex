...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Types of error bar}, toptitle=1mm, coltitle=black, bottomtitle=1mm, opacitybacktitle=0.6, opacityback=0, colback=white, bottomrule=.15mm, left=2mm, leftrule=.75mm, toprule=.15mm, breakable, colframe=quarto-callout-note-color-frame, arc=.35mm, titlerule=0mm, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white]
