...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, coltitle=black, left=2mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, arc=.35mm, bottomtitle=1mm, rightrule=.15mm, opacitybacktitle=0.6, colback=white, toptitle=1mm, breakable, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Types of error bar}, opacityback=0]
...
several choices of how to do so and each has its pros and cons.
