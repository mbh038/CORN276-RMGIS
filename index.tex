...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, arc=.35mm, toptitle=1mm, leftrule=.75mm, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Types of error bar}, breakable, coltitle=black, bottomtitle=1mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, opacitybacktitle=0.6, toprule=.15mm, left=2mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white]
