...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, colframe=quarto-callout-note-color-frame, arc=.35mm, opacitybacktitle=0.6, leftrule=.75mm, breakable, opacityback=0, toprule=.15mm, bottomrule=.15mm, toptitle=1mm, colback=white, rightrule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Types of error bar}, left=2mm, coltitle=black]
...
sample using the formula \(\test{SE}=\frac{\text{SD}}{sqrt{n}}\) where
...
do this becuase we want to get an idea, from our samples, of how
plausible it is that the population means differ from each other. These
population means could plausibly lie anyhwere in the range that is our
...
\pandocbounded{\includegraphics[keepaspectratio]{visualising_data_files/figure-pdf/unnamed-chunk-6-1.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{visualising_data_files/figure-pdf/unnamed-chunk-7-1.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{visualising_data_files/figure-pdf/unnamed-chunk-8-1.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{visualising_data_files/figure-pdf/unnamed-chunk-9-1.pdf}}
...
\caption{\label{fig-bar-charts}Charts}
