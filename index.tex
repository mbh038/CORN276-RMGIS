...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Types of error bar}, left=2mm, bottomtitle=1mm, coltitle=black, toprule=.15mm, titlerule=0mm, opacityback=0, arc=.35mm, toptitle=1mm, colback=white, rightrule=.15mm, bottomrule=.15mm]
...
widths of the ditributions of the three data sets. When we do actually
