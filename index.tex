...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, left=2mm, opacityback=0, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, rightrule=.15mm, colback=white, arc=.35mm, coltitle=black, leftrule=.75mm, breakable, bottomtitle=1mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Types of error bar}, opacitybacktitle=0.6]
