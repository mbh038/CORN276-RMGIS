...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, toptitle=1mm, bottomrule=.15mm, titlerule=0mm, rightrule=.15mm, breakable, colback=white, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Types of error bar}, arc=.35mm, toprule=.15mm, opacitybacktitle=0.6, coltitle=black, opacityback=0]
