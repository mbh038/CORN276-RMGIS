...
Histograms can also be used to inspect a data set, even one with multiple categories, as with the penguin data. Unlike bar charts they show the  distribution of a dataset, including its centtal value, spread and symmetry, or lack thereof.
