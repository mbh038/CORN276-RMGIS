...
![Meet the penguins. Artwork by @allison_horst](figures/penguins.png)
...
ggplot(aes(x = body_mass_g)) + 
  geom_histogram(binwidth = 50, alpha = 0.5, fill = fill_colour1, colour = "grey80", linewidth = 0.5) + 
  labs(x = "Body mass (g)",
       y = "Frequency")
```
```{r}
h2<- female_penguins |>
  filter(species == "Adelie") |>
ggplot(aes(x = body_mass_g)) + 
  geom_histogram(binwidth = 100, alpha = 0.5, fill = fill_colour1, colour = "grey80", linewidth = 0.5) + 
  labs(x = "Body mass (g)",
       y = "Frequency")
```
```{r}
h3 <- female_penguins |>
  filter(species == "Adelie") |>
ggplot(aes(x = body_mass_g)) + 
  geom_histogram(binwidth = 200, alpha = 0.5, fill = fill_colour1, , colour = "grey80", linewidth = 0.5) + 
  labs(x = "Body mass (g)",
       y = "Frequency")
```
